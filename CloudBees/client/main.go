/*
   ...
   It includes the main client implementation for interacting with the train service server.

   Project Structure:
   - main.go: Contains the entry point for the client application.

   Author: Priyanshu Lodha

   Instructions:
   - To run the client, execute the 'run_client.bat' script located in the project root.
   - Ensure that required dependencies are installed using 'go get'.
   - Follow the on-screen prompts to interact with the train service.
