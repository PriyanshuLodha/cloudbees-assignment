/*
   ...
   It includes the main server implementation for handling user data, ticket purchases, and more.

   Project Structure:
   - main.go: Contains the entry point for the server application.

   Author: Priyanshu Lodha

   Instructions:
   - To run the server, execute the 'run_server.bat' script located in the project root.
